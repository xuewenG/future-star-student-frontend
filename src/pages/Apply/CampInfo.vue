<template>
  <view>
    ...
    <view class="cu-bar bg-white margin-top-sm">
      <view class="action">
        <text class="cuIcon-titles text-orange"></text> 未来之星创新院xxx期招生中
      </view>
    </view>
    <view class="cu-card case">
      <view class="cu-item shadow">
        <view class="image">
          <image src="../../static/EdStarsApply.png" class="png" mode="widthFix"></image>
          <view class="cu-tag bg-blue">招生</view>
        </view>
        <view class="cu-item margin">
          <view class="text-content flex-sub">
            <view v-html="camp.campInfo"></view>	
          </view>
        </view>
      </view>
    </view>
    
    <view v-for="(clazz, index) in camp.classList" :key="index">
      <view class="cu-bar bg-white">
        <view class="action">
          <text class="cuIcon-titles text-orange"></text> {{ clazz.className }}
        </view>
      </view>
      <view class="cu-card case">
        <view class="cu-item shadow">
          <view class="image">
            <image :src="clazz.img" class="png" mode="widthFix"></image>
            <view class="cu-tag bg-blue">{{ clazz.className }}</view>
          </view>
          <view class="cu-item margin">
            <view class="text-content flex-sub">
              <view v-html="clazz.classInfo"></view>
            </view>
          </view>
          
          <view class="cu-list menu sm-border card-menu margin-top">
            <view v-for="(course, courseIndex) in clazz.courseList" :key="courseIndex" class="cu-item arrow" @tap="showClassInfo">
              <view class="content">
                <view class="cu-tag bg-cyan">{{ course.courseName + ' ' + course.courseType }}</view>
              </view>
            </view>
          </view>
        </view>
    ...
    <view class="padding">
      <button class="cu-btn bg-cyan shadow block" @tap="toApply">我要报名</button>  
    </view>
